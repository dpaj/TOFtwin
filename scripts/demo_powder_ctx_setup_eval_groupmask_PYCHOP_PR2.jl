...
σt_source = lowercase(get(ENV, "TOFTWIN_SIGMA_T_SOURCE", "manual"))
...
pychop_freq_hz = isempty(strip(pychop_freq_str)) ? Float64[] : parse.(Float64, split(pychop_freq_str, [',',' ';'\t'], keepempty=false))
